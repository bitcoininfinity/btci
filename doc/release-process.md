...
### Build and sign btci Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit btci=v${VERSION} ../btci/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../btci/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/btci-*.tar.gz build/out/src/btci-*.tar.gz ../
    popd
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import btci/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [btci-detached-sigs](https://github.com/forking-altcoins/btci-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the btci.org server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/forking-altcoins/btci/releases/new) with a link to the archived release notes.
