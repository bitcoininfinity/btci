                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("btci Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a btci address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and btci: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About btci Core"), this);
    aboutAction->setStatusTip(tr("Show information about btci Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for btci"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your btci addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified btci addresses"));
    ...
    openAction->setStatusTip(tr("Open a btci: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible btci command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("btci Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to btci network", "", count));
}
...
{
    QString strTitle = tr("btci Core"); // default title
