...
/* btci GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "btci"
#define QAPP_ORG_DOMAIN "btci.org"
#define QAPP_APP_NAME_DEFAULT "btci-Qt"
#define QAPP_APP_NAME_TESTNET "btci-Qt-testnet"
