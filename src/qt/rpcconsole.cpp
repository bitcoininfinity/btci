...
// Copyright (c) 2015-2018 The btci developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzbtciPathCustom = GetArg("-zbtcibackuppath", "");
    ...
    if(!strzbtciPathCustom.empty()) {
        ui->wallet_customzbtcibackuppath->setText(QString::fromStdString(strzbtciPathCustom));
        ui->wallet_customzbtcibackuppath_label->setVisible(true);
        ui->wallet_customzbtcibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzbtciPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the btci RPC console.") + "<br>" +
