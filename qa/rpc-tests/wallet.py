...
#   c) node1 mines 32 blocks, so now node 0 has 60001btci, node 1 has 4250btci, node2 has none.
#   d) node0 sends 601 btci to node2, in two transactions (301 btci, then 300 btci).
