Contributing to btci Core
============================

The btci Core project operates an open contributor model where anyone is
...
The following applies to code changes to the btci Core project, and is not to be
confused with overall btci Network Protocol consensus changes.

Whether a pull request is merged into btci Core rests with the project merge
...
Patches that change btci consensus rules are considerably more involved than
...
Where a patch set proposes to change the btci consensus, it must have been
...
The project leader is the release manager for each btci Core release.
