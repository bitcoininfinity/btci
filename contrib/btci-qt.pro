...
RESOURCES += src/qt/btci.qrc src/qt/btci_locale.qrc

TRANSLATIONS += src/qt/locale/btci_bg.ts \
                src/qt/locale/btci_de.ts \
                src/qt/locale/btci_en.ts \
                src/qt/locale/btci_es.ts \
                src/qt/locale/btci_fi.ts \
                src/qt/locale/btci_fr.ts \
                src/qt/locale/btci_it.ts \
                src/qt/locale/btci_ja.ts \
                src/qt/locale/btci_pl.ts \
                src/qt/locale/btci_pt.ts \
                src/qt/locale/btci_ru.ts \
                src/qt/locale/btci_sk.ts \
                src/qt/locale/btci_sv.ts \
                src/qt/locale/btci_vi.ts \
                src/qt/locale/btci_zh_CN.ts \
                src/qt/locale/btci_zh_TW.ts
